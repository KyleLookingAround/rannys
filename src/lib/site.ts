...
// (see the schema): the display table, the home-hero short line, the status
// pill text, the live open/closed pill data, and the Google (schema.org)
// hours. Nothing to keep in sync by hand. Sun=0 to match JS getDay().
...
/** Compact time for the hero line: "07:00" → "7", "10:30" → "10:30". */
...
/** Open day codes in Mon-first week order (a range like Tu-Fr is expanded). */
...
/** Status-pill text (pre-JS / no-JS fallback), e.g. "Open Tue–Sun". */
...
/** Compact home-hero hours line, e.g. "Tue–Fri 7–4 · Sat 9–3 · Sun 10–3". */
